 ...
 * between oCIS and ownCloud. This suite covers sending and accepting invitation links,
...
describe("Invite link federated sharing via ScienceMesh functionality between oCIS and ownCloud", () => {
  ...
  const recipientUrl =
    Cypress.env("OWNCLOUD1_URL") || "https://owncloud1.docker";
  ...
  const recipientPassword =
    Cypress.env("OWNCLOUD1_PASSWORD") || "radioactivity";
   ...
   */
  it("Send invitation from oCIS to ownCloud", () => {
   ...
   */
  it("Accept invitation from oCIS to ownCloud", () => {
   ...
   */
  it("Send ScienceMesh share <file> from oCIS to ownCloud", () => {
   ...
   */
  it("Receive ScienceMesh share <file> from oCIS to ownCloud", () => {
