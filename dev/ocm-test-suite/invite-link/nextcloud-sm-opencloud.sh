...
# -----------------------------------------------------------------------------------
# Script to Test Nextcloud to Opencloud OCM invite link flow tests.
...
#   specifically Nextcloud and Opencloud, using ScienceMesh integration and tools like Reva, Cypress, and Docker containers.
#   It supports both development and CI environments, with optional browser support.
# Usage:
#   ./nextcloud-opencloud.sh [EFSS_PLATFORM_1_VERSION] [EFSS_PLATFORM_2_VERSION] [SCRIPT_MODE] [BROWSER_PLATFORM]
# Arguments:
#   EFSS_PLATFORM_1_VERSION : Version of Nextcloud (default: "v2.3.0").
#   EFSS_PLATFORM_2_VERSION : Version of Opencloud (default: "5.0.9").
...
# Example:
#   ./nextcloud-opencloud.sh v2.3.0 5.0.9 ci electron
# -----------------------------------------------------------------------------------
