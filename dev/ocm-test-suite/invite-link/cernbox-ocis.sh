...
# -----------------------------------------------------------------------------------
# Script to Test CERNBox to oCIS OCM invite link flow tests.
...
#   specifically CERNBox and oCIS, using ScienceMesh integration and tools like Reva, Cypress, and Docker containers.
