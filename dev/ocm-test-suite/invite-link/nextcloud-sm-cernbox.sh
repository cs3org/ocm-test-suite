...
# -----------------------------------------------------------------------------------
# Script to Test Nextcloud to CERNBox OCM invite link flow tests.
...
#   specifically Nextcloud and CERNBox, using ScienceMesh integration and tools like Reva, Cypress, and Docker containers.
#   It supports both development and CI environments, with optional browser support.
# Usage:
#   ./nextcloud-cernbox.sh [EFSS_PLATFORM_1_VERSION] [EFSS_PLATFORM_2_VERSION] [SCRIPT_MODE] [BROWSER_PLATFORM]
# Arguments:
#   EFSS_PLATFORM_1_VERSION : Version of Nextcloud (default: "v27.1.11-sm").
...
# Example:
#   ./nextcloud-cernbox.sh v27.1.11-sm v2 ci electron
# -----------------------------------------------------------------------------------
...
main() {
    ...
    # Create Nextcloud container (sender)
