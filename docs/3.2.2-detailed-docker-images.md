...
| Version | Docker Pull Command | Description |
|---------|-------------------|-------------|
| v1.0.0 | `docker pull pondersource/ocmstub:v1.0.0` | Stub v1 baseline for login, share-with, and share-link scenarios |
| v1.1.0 | `docker pull pondersource/ocmstub:v1.1.0` | Stub v1 image used for invite-link and meshdir scenarios |
| latest | `docker pull pondersource/ocmstub:latest` | Development build, usually tracking the latest Stub v1 tag |
