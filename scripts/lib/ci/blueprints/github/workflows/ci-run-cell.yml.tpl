...
# Breaking change: workflow_call input `scenario` was renamed to `flow`.
# Callers must pass `flow:`; there is no compatibility shim.
    ...
    steps:
      ...
      - name: Pre-pull runtime images
        ...
        run: |
          ...
          nu scripts/ocmts.nu services list-cell-images "${ARGS[@]}" | while IFS= read -r img; do
            [ -z "$img" ] && continue
            docker pull "$img"
          done
