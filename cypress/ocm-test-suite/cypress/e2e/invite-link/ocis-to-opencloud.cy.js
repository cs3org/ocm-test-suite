 ...
 * between oCIS and Opencloud. This suite covers sending and accepting invitation links,
...
describe("Invite link federated sharing via ScienceMesh functionality between oCIS and Opencloud", () => {
  ...
  const inviteLinkFileName = "invite-link-ocis-opencloud.txt";
   ...
   */
  it("Send invitation from oCIS to Opencloud", () => {
   ...
   */
  it("Accept invitation from oCIS to Opencloud", () => {
   ...
   */
  it("Receive ScienceMesh share <file> from oCIS to Opencloud", () => {
