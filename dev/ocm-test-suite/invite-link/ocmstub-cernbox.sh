...
# -----------------------------------------------------------------------------------
# Script to Test OCMStub to CERNBox OCM invite-link flow tests.
...
#   such as OCMStub and CERNBox, using Cypress, and Docker containers.
#   It supports both development and CI environments, with optional browser support.
# Usage:
#   ./ocmstub-cernbox.sh [EFSS_PLATFORM_1_VERSION] [EFSS_PLATFORM_2_VERSION] [SCRIPT_MODE] [BROWSER_PLATFORM]
# Arguments:
...
# Example:
#   ./ocmstub-cernbox.sh v1.0.0 v2 ci electron
# -----------------------------------------------------------------------------------
...
main() {
    ...
    # Create OCMStub as EFSS 1 (inviter)
    #                # id   # image                 # tag
    ...
    # Create CERNBox v2 as EFSS 2 (receiver)
